        ...
        <div class="recent-grid">
                <div class="projects">
                    <div class="card">
                        ...
                        <h3>Perhitungan</h3>
                        <button onclick="location.href='create_perhitungan.php'"  style="cursor: pointer;">Tambah</button>
                        </div>
                        <div class="card-body">
                            ...
                            <table width="100%">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="edit_perhitungan.php?id_perhitungan=<?php echo $row["id_perhitungan"]; ?>"><span title="Edit" style="font-size: 24px; color: orange;">
                                                                                                                <i class="fas fa-edit"></i>
                                                                                                            </span></a> &nbsp; &nbsp;
                                                <a href="delete_perhitungan.php?id_perhitungan=<?php echo $row["id_perhitungan"]; ?>"><span title="Hapus" style="font-size: 24px; color: red;">
                                    ...
                                    echo "<tr><td colspan='5'>Tidak ada data perhitungan.</td></tr>";
                                }
                                ?>
                                </tbody>
                            </table>
