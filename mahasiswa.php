            ...
            <div class="recent-grid">
                <div class="projects">
                    <div class="card">
                        ...
                        <button onclick="location.href='create_data.php'"  style="cursor: pointer;">Tambah</button>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["pekerjaan_orangtua"]; ?></td>
                                            <td>
                                                <!-- Tambahkan aksi sesuai kebutuhan, misalnya tombol edit, hapus, dll -->
                                                <a href="edit_data.php?id_mahasiswa=<?php echo $row["id_mahasiswa"]; ?>"><span title="Edit" style="font-size: 24px; color: orange;">
                                                                                                                <i class="fas fa-edit"></i>
                                                                                                            </span></a> &nbsp; &nbsp;
                                                <a href="delete_data.php?id_mahasiswa=<?php echo $row["id_mahasiswa"]; ?>"><span title="Hapus" style="font-size: 24px; color: red;">
