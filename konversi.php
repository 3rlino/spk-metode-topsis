            ...
            <div class="recent-grid">
                <div class="projects">
                    <div class="card">
                        ...
                        <button onclick="location.href='create_konversi.php'"  style="cursor: pointer;">Tambah</button>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["nilai_alternatif"]; ?></td>
                                            <td><?php echo $row["bobot"]; ?></td>
                                            <td>
                                                <!-- Tambahkan aksi sesuai kebutuhan, misalnya tombol edit, hapus, dll -->
                                                <a href="edit_konversi.php?id_konver=<?php echo $row["id_konver"]; ?>">  <span title="Edit" style="font-size: 24px; color: orange;">
                                                                                                                <i class="fas fa-edit"></i>
                                                                                                            </span></a> &nbsp; &nbsp;
                                                <a href="delete_konversi.php?id_konver=<?php echo $row["id_konver"]; ?>"><span title="Hapus" style="font-size: 24px; color: red;">
                                    ...
                                    echo "<tr><td colspan='5'>Tidak ada data konversi.</td></tr>";
                                }
                                ?>
                                </tbody>
                            </table>
