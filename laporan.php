...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <li>
                <a href="laporan.php" class="active"><span class="las la-file-alt"></span></span><span>Hasil Topsis</span></a>
            </li>
            </ul>
        </div>
    </div>
        ...
        <div class="recent-grid">
                <div class="projects">
                    <div class="card">
                        ...
                        <h3>Hasil Topsis</h3>
                        <button onclick="location.href='create_laporan.php'"  style="cursor: pointer;">Tambah</button>
                        </div>
                        <div class="card-body">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["hasil_perhitungan"]; ?></td>
                                            <td>
                                                <!-- Tambahkan aksi sesuai kebutuhan, misalnya tombol edit, hapus, dll -->
                                                <a href="edit_laporan.php?id_hasil_topsis=<?php echo $row["id_hasil_topsis"]; ?>"><span title="Edit" style="font-size: 24px; color: orange;">
                                                                                                                <i class="fas fa-edit"></i>
                                                                                                            </span></a> &nbsp; &nbsp;
                                                <a href="delete_laporan.php?id_hasil_topsis=<?php echo $row["id_hasil_topsis"]; ?>"><span title="Hapus" style="font-size: 24px; color: red;">
                                    ...
                                    echo "<tr><td colspan='5'>Tidak ada data hasil topsis.</td></tr>";
                                }
                                ?>
                                </tbody>
                            </table>
